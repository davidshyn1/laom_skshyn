...
from train_laom_labels_IB import BCConfig, DecoderConfig, evaluate, train_act_decoder, train_bc
...
_DEFAULT_EVAL_DATA_PATH = "/yj_hdd/skshyn/lam/dataset/data/hopper-hop-10x-test.hdf5"
...
class Config:
    project: str = "laom"
    group: str = "laom-statesigreg-labels-ib"
    environment: Optional[str] = None
    name: str = "laom-statesigreg-labels-ib"
    seed: int = 0
